...
<body>
            ...
            <div class="container ">
                <div class="row">
                    ...
                    <div class="col-12 pb-5 text-center">
                        ...
                        <button class="custom-outline-button" onclick="viewOrderHistory()">Your Order</button>
                    </div>
    ...
    <div class="notification" id="cartNotification" style="display: none;">
                        ...
                        document.addEventListener("DOMContentLoaded", () => {
                            ...
                            addToCartButtons.forEach(button => {
                                button.addEventListener("click", (event) => {
                                    ...
                                    showNotification(); // Show notification after adding to cart
                                });
                            });
                            ...
                            // Add item to the cart stored in localStorage
                            ...
                            function viewCart() {
                                ...
                                renderCart(cartWindow, cart); // Render the cart
                            }

                            // Render the cart in the cart window
                ...
                `).join("<br>");
                    ...
                    <button onclick="opener.openOrderForm()">Order</button>
                `;
                            }
                            ...
                            window.openOrderForm = function() {
                                ...
                                // Open a new order window or focus on an existing one
                                if (!orderWindow || orderWindow.closed) {
                                    orderWindow = window.open("", "Order", "width=600,height=700");
                                } else {
                                    orderWindow.focus();
                                }
                ...
                `).join("");
                                ...
                                orderWindow.document.body.innerHTML = `
                    <h1>Order Form</h1>
                    <form id="orderForm">
                        <label for="orderName">Name:</label>
                        <input type="text" id="orderName" name="orderName" required><br><br>
                        ...
                        <input type="text" id="totalAmount" name="totalAmount" value="Rs ${totalAmount}" readonly><br><br>
                ...
                `;
                                ...
                                orderWindow.document.getElementById("orderForm").addEventListener("submit", function(event) {
                                    event.preventDefault();

                                    const name = orderWindow.document.getElementById("orderName").value;
                                    const email = orderWindow.document.getElementById("email").value;
                                    const tableNumber = orderWindow.document.getElementById("tableNumber").value;
                                    const paymentMethod = orderWindow.document.getElementById("paymentMethod").value;

                                    if (!name || !email || !tableNumber || !paymentMethod) {
                                    ...
                                    // Store the placed order in the order history
                                    ...
                                    orderWindow.close();
                                    orderWindow = null; // Reset the order window for the next order
                                });
                            };
                            ...
                            window.viewOrderHistory = function() {
                                ...
                                let orderList = orderHistory.map((order, index) => `
                    <h3>Order #${index + 1}</h3>
                    <p>Name: ${order.name}</p>
                ...
                `).join("<br>");
                                ...
                                const orderHistoryWindow = window.open("", "Order History", "width=600,height=700");
                                orderHistoryWindow.document.body.innerHTML = `
                ...
                `;
                            ...
                            window.viewCart = viewCart; // Expose viewCart to the global scope for use
                        });
                    </script>
    <div id="section2">
        <div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 shadow mt-2 mb-3 pb-5">
                        <div class="explore-part-container  pb-3 ">
                            ...
                            <button class="button-part-2 add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 shadow mt-3 mb-3 pb-5">
                        <div class="explore-part-container  pb-3 ">
                            ...
                            <p class="para-north">North, Southern, Andhra </p>
                            <p class=" para-north" style="font-weight:bold; color:green;"> Rs 60</p>
                            <button class="button-part-2  add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 shadow mt-3 mb-3 pb-5">
                        <div class="explore-part-container pb-3 ">
                            ...
                            <p class="para-north">North, Southern, Andhra </p>
                            <p class=" para-north" style="font-weight:bold; color:green;"> Rs 40</p>
                            <button class="button-part-2  add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 shadow mt-3 mb-3 pb-5">
                        <div class="explore-part-container pb-3 ">
                            ...
                            <p class="para-north">North, Southern, Andhra </p>
                            <p class=" para-north" style="font-weight:bold; color:green;"> Rs 140</p>
                            <button class="button-part-2  add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 shadow mt-3 mb-3 pb-5">
                        <div class="explore-part-container  pb-3 ">
                            ...
                            <p class="para-north">North, Southern, Andhra </p>
                            <p class=" para-north" style="font-weight:bold; color:green;"> Rs 155</p>
                            <button class="button-part-2  add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 shadow mt-3 mb-3 pb-5">
                        <div class="explore-part-container  pb-3 ">
                            ...
                            <p class="para-north">North, Southern, Andhra </p>
                            <p class=" para-north" style="font-weight:bold; color:green;"> Rs 30</p>
                            <button class="button-part-2  add-to-cart">Add to Cart</button>
                        </div>
                    </div>
